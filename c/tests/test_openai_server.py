...
class FakeEngine:
    ...
    def generate(self, prompt, maximum, temperature, top_p, on_text, cache_slot=0, top_k=0, seed=0, min_p=0.0):
        self.calls.append((prompt, maximum, temperature, top_p, cache_slot, top_k, seed, min_p))
        on_text("Hé")
        on_text("llo")
