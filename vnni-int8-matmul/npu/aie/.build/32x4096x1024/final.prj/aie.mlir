  ...
  aie.device(npu2_1col) {
    ...
    %0 = aie.core(%logical_core) {
      ...
      scf.for %arg0 = %c0 to %c9223372036854775807 step %c1 {
        ...
        scf.for %arg1 = %c0_4 to %c32 step %c1_5 {
          ...
          scf.for %arg2 = %c0_6 to %c64 step %c1_7 {
            ...
            %collapse_shape_8 = memref.collapse_shape %4 [[0, 1]] : memref<16x64xi8> into memref<1024xi8>
            %collapse_shape_9 = memref.collapse_shape %6 [[0, 1]] : memref<64x64xi8> into memref<4096xi8>
            %collapse_shape_10 = memref.collapse_shape %2 [[0, 1]] : memref<16x64xi32> into memref<1024xi32>
            func.call @e5b22372_matmul_i8_i32(%collapse_shape_8, %collapse_shape_9, %collapse_shape_10) : (memref<1024xi8>, memref<4096xi8>, memref<1024xi32>) -> ()
    ...
    aie.runtime_sequence(%arg0: memref<131072xi8>, %arg1: memref<4194304xi8>, %arg2: memref<32768xi32>) {
      %1 = aiex.dma_configure_task_for @inA {
        aie.dma_bd(%arg0 : memref<131072xi8>, 0, 65536, [<size = 16, stride = 0>, <size = 64, stride = 64>, <size = 16, stride = 4096>, <size = 64, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      } {repeat_count = 15 : i32}
      aiex.dma_start_task(%1)
      %2 = aiex.dma_configure_task_for @inB {
        aie.dma_bd(%arg1 : memref<4194304xi8>, 0, 262144, [<size = 16, stride = 262144>, <size = 64, stride = 64>, <size = 64, stride = 4096>, <size = 64, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      } {repeat_count = 15 : i32}
      aiex.dma_start_task(%2)
      %3 = aiex.dma_configure_task_for @inA {
        aie.dma_bd(%arg0 : memref<131072xi8>, 65536, 65536, [<size = 16, stride = 0>, <size = 64, stride = 64>, <size = 16, stride = 4096>, <size = 64, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      } {repeat_count = 15 : i32}
      ...
      %5 = aiex.dma_configure_task_for @outC {
        aie.dma_bd(%arg2 : memref<32768xi32>, 0, 16384, [<size = 2, stride = 16384>, <size = 16, stride = 64>, <size = 16, stride = 1024>, <size = 64, stride = 1>]) {burst_length = 0 : i32}
        aie.end
