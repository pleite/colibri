module {
  aie.device(npu2_1col) {
    ...
    %inA_cons_buff_0 = aie.buffer(%mem_tile_0_1) {address = 49152 : i32, sym_name = "inA_cons_buff_0"} : memref<16x32xi8> 
    %inA_cons_buff_1 = aie.buffer(%mem_tile_0_1) {address = 49664 : i32, sym_name = "inA_cons_buff_1"} : memref<16x32xi8> 
    ...
    %memC_buff_0 = aie.buffer(%tile_0_2) {address = 3328 : i32, sym_name = "memC_buff_0"} : memref<16x256xi32> 
    %memC_buff_1 = aie.buffer(%tile_0_2) {address = 19712 : i32, sym_name = "memC_buff_1"} : memref<16x256xi32> 
    ...
    %memB_cons_buff_0 = aie.buffer(%tile_0_2) {address = 36096 : i32, sym_name = "memB_cons_buff_0"} : memref<32x256xi8> 
    %memB_cons_buff_1 = aie.buffer(%tile_0_2) {address = 44288 : i32, sym_name = "memB_cons_buff_1"} : memref<32x256xi8> 
    ...
    %inB_cons_buff_0 = aie.buffer(%mem_tile_0_1) {address = 32768 : i32, sym_name = "inB_cons_buff_0"} : memref<32x256xi8> 
    %inB_cons_buff_1 = aie.buffer(%mem_tile_0_1) {address = 40960 : i32, sym_name = "inB_cons_buff_1"} : memref<32x256xi8> 
    ...
    %memA_cons_buff_0 = aie.buffer(%tile_0_2) {address = 52480 : i32, sym_name = "memA_cons_buff_0"} : memref<16x32xi8> 
    %memA_cons_buff_1 = aie.buffer(%tile_0_2) {address = 52992 : i32, sym_name = "memA_cons_buff_1"} : memref<16x32xi8> 
    ...
    %memC_cons_buff_0 = aie.buffer(%mem_tile_0_1) {address = 0 : i32, sym_name = "memC_cons_buff_0"} : memref<16x256xi32> 
    %memC_cons_buff_1 = aie.buffer(%mem_tile_0_1) {address = 16384 : i32, sym_name = "memC_cons_buff_1"} : memref<16x256xi32> 
    %memC_cons_prod_lock_0 = aie.lock(%mem_tile_0_1, 0) {init = 2 : i32, sym_name = "memC_cons_prod_lock_0"}
    %memC_cons_cons_lock_0 = aie.lock(%mem_tile_0_1, 1) {init = 0 : i32, sym_name = "memC_cons_cons_lock_0"}
    ...
    %_anonymous0 = aie.buffer(%tile_0_2) {address = 53504 : i32, sym_name = "_anonymous0"} : memref<3xi32> 
    ...
    ^bb5:  // pred: ^bb4
      cf.br ^bb8(%memC_buff_0 : memref<16x256xi32>)
    ^bb6:  // pred: ^bb4
      cf.br ^bb8(%memC_buff_1 : memref<16x256xi32>)
    ^bb7:  // pred: ^bb4
      cf.br ^bb8(%memC_buff_0 : memref<16x256xi32>)
    ^bb8(%7: memref<16x256xi32>):  // 3 preds: ^bb5, ^bb6, ^bb7
      %collapse_shape = memref.collapse_shape %7 [[0, 1]] : memref<16x256xi32> into memref<4096xi32>
    ...
    ^bb11:  // pred: ^bb10
      cf.br ^bb14(%memA_cons_buff_0 : memref<16x32xi8>)
    ^bb12:  // pred: ^bb10
      cf.br ^bb14(%memA_cons_buff_1 : memref<16x32xi8>)
    ^bb13:  // pred: ^bb10
      cf.br ^bb14(%memA_cons_buff_0 : memref<16x32xi8>)
    ^bb14(%13: memref<16x32xi8>):  // 3 preds: ^bb11, ^bb12, ^bb13
    ...
    ^bb15:  // pred: ^bb14
      cf.br ^bb18(%memB_cons_buff_0 : memref<32x256xi8>)
    ^bb16:  // pred: ^bb14
      cf.br ^bb18(%memB_cons_buff_1 : memref<32x256xi8>)
    ^bb17:  // pred: ^bb14
      cf.br ^bb18(%memB_cons_buff_0 : memref<32x256xi8>)
    ^bb18(%17: memref<32x256xi8>):  // 3 preds: ^bb15, ^bb16, ^bb17
      %collapse_shape_0 = memref.collapse_shape %13 [[0, 1]] : memref<16x32xi8> into memref<512xi8>
      %collapse_shape_1 = memref.collapse_shape %17 [[0, 1]] : memref<32x256xi8> into memref<8192xi8>
      func.call @"58a6969e_matmul_i8_i32"(%collapse_shape_0, %collapse_shape_1, %collapse_shape) : (memref<512xi8>, memref<8192xi8>, memref<4096xi32>) -> ()
    ...
    ^bb21:  // pred: ^bb1
      aie.end
    } {link_files = ["matmul_i8_i32_58a6969e.o"], stack_size = 3328 : i32}
    ...
    ^bb1:  // 2 preds: ^bb0, ^bb2
      ...
      aie.dma_bd(%inA_cons_buff_0 : memref<16x32xi8>, 0, 512) {bd_id = 0 : i32, next_bd_id = 1 : i32}
      aie.use_lock(%inA_cons_cons_lock_0, Release, 1)
      aie.next_bd ^bb2
    ^bb2:  // pred: ^bb1
      aie.use_lock(%inA_cons_prod_lock_0, AcquireGreaterEqual, 1)
      aie.dma_bd(%inA_cons_buff_1 : memref<16x32xi8>, 0, 512) {bd_id = 1 : i32, next_bd_id = 0 : i32}
      aie.use_lock(%inA_cons_cons_lock_0, Release, 1)
      aie.next_bd ^bb1
    ^bb3:  // pred: ^bb0
    ...
    ^bb4:  // 2 preds: ^bb3, ^bb5
      ...
      aie.dma_bd(%inA_cons_buff_0 : memref<16x32xi8>, 0, 512, [<size = 2, stride = 256>, <size = 4, stride = 8>, <size = 8, stride = 32>, <size = 8, stride = 1>]) {bd_id = 2 : i32, next_bd_id = 3 : i32}
      aie.use_lock(%inA_cons_prod_lock_0, Release, 1)
      aie.next_bd ^bb5
    ^bb5:  // pred: ^bb4
      aie.use_lock(%inA_cons_cons_lock_0, AcquireGreaterEqual, 1)
      aie.dma_bd(%inA_cons_buff_1 : memref<16x32xi8>, 0, 512, [<size = 2, stride = 256>, <size = 4, stride = 8>, <size = 8, stride = 32>, <size = 8, stride = 1>]) {bd_id = 3 : i32, next_bd_id = 2 : i32}
      aie.use_lock(%inA_cons_prod_lock_0, Release, 1)
      aie.next_bd ^bb4
    ^bb6:  // pred: ^bb3
    ...
    ^bb7:  // 2 preds: ^bb6, ^bb8
      ...
      aie.dma_bd(%inB_cons_buff_0 : memref<32x256xi8>, 0, 8192) {bd_id = 24 : i32, next_bd_id = 25 : i32}
      aie.use_lock(%inB_cons_cons_lock_0, Release, 1)
      aie.next_bd ^bb8
    ^bb8:  // pred: ^bb7
      aie.use_lock(%inB_cons_prod_lock_0, AcquireGreaterEqual, 1)
      aie.dma_bd(%inB_cons_buff_1 : memref<32x256xi8>, 0, 8192) {bd_id = 25 : i32, next_bd_id = 24 : i32}
      aie.use_lock(%inB_cons_cons_lock_0, Release, 1)
      aie.next_bd ^bb7
    ^bb9:  // pred: ^bb6
    ...
    ^bb10:  // 2 preds: ^bb9, ^bb11
      ...
      aie.dma_bd(%inB_cons_buff_0 : memref<32x256xi8>, 0, 8192, [<size = 32, stride = 256>, <size = 4, stride = 8>, <size = 8, stride = 32>, <size = 8, stride = 1>]) {bd_id = 26 : i32, next_bd_id = 27 : i32}
      aie.use_lock(%inB_cons_prod_lock_0, Release, 1)
      aie.next_bd ^bb11
    ^bb11:  // pred: ^bb10
      aie.use_lock(%inB_cons_cons_lock_0, AcquireGreaterEqual, 1)
      aie.dma_bd(%inB_cons_buff_1 : memref<32x256xi8>, 0, 8192, [<size = 32, stride = 256>, <size = 4, stride = 8>, <size = 8, stride = 32>, <size = 8, stride = 1>]) {bd_id = 27 : i32, next_bd_id = 26 : i32}
      aie.use_lock(%inB_cons_prod_lock_0, Release, 1)
      aie.next_bd ^bb10
    ^bb12:  // pred: ^bb9
    ...
    ^bb13:  // 2 preds: ^bb12, ^bb14
      ...
      aie.dma_bd(%memC_cons_buff_0 : memref<16x256xi32>, 0, 4096) {bd_id = 4 : i32, next_bd_id = 5 : i32}
      aie.use_lock(%memC_cons_cons_lock_0, Release, 1)
      aie.next_bd ^bb14
    ^bb14:  // pred: ^bb13
      aie.use_lock(%memC_cons_prod_lock_0, AcquireGreaterEqual, 1)
      aie.dma_bd(%memC_cons_buff_1 : memref<16x256xi32>, 0, 4096) {bd_id = 5 : i32, next_bd_id = 4 : i32}
      aie.use_lock(%memC_cons_cons_lock_0, Release, 1)
      aie.next_bd ^bb13
    ^bb15:  // pred: ^bb12
    ...
    ^bb16:  // 2 preds: ^bb15, ^bb17
      ...
      aie.dma_bd(%memC_cons_buff_0 : memref<16x256xi32>, 0, 4096, [<size = 2, stride = 2048>, <size = 8, stride = 8>, <size = 32, stride = 64>, <size = 8, stride = 1>]) {bd_id = 6 : i32, next_bd_id = 7 : i32}
      aie.use_lock(%memC_cons_prod_lock_0, Release, 1)
      aie.next_bd ^bb17
    ^bb17:  // pred: ^bb16
      aie.use_lock(%memC_cons_cons_lock_0, AcquireGreaterEqual, 1)
      aie.dma_bd(%memC_cons_buff_1 : memref<16x256xi32>, 0, 4096, [<size = 2, stride = 2048>, <size = 8, stride = 8>, <size = 32, stride = 64>, <size = 8, stride = 1>]) {bd_id = 7 : i32, next_bd_id = 6 : i32}
      aie.use_lock(%memC_cons_prod_lock_0, Release, 1)
      aie.next_bd ^bb16
    ^bb18:  // pred: ^bb15
      aie.end
    ...
    ^bb1:  // 2 preds: ^bb0, ^bb2
      ...
      aie.dma_bd(%memA_cons_buff_0 : memref<16x32xi8>, 0, 512) {bd_id = 0 : i32, next_bd_id = 1 : i32}
      aie.use_lock(%memA_cons_cons_lock_0, Release, 1)
      aie.next_bd ^bb2
    ^bb2:  // pred: ^bb1
      aie.use_lock(%memA_cons_prod_lock_0, AcquireGreaterEqual, 1)
      aie.dma_bd(%memA_cons_buff_1 : memref<16x32xi8>, 0, 512) {bd_id = 1 : i32, next_bd_id = 0 : i32}
      aie.use_lock(%memA_cons_cons_lock_0, Release, 1)
      aie.next_bd ^bb1
    ^bb3:  // pred: ^bb0
    ...
    ^bb4:  // 2 preds: ^bb3, ^bb5
      ...
      aie.dma_bd(%memB_cons_buff_0 : memref<32x256xi8>, 0, 8192) {bd_id = 2 : i32, next_bd_id = 3 : i32}
      aie.use_lock(%memB_cons_cons_lock_0, Release, 1)
      aie.next_bd ^bb5
    ^bb5:  // pred: ^bb4
      aie.use_lock(%memB_cons_prod_lock_0, AcquireGreaterEqual, 1)
      aie.dma_bd(%memB_cons_buff_1 : memref<32x256xi8>, 0, 8192) {bd_id = 3 : i32, next_bd_id = 2 : i32}
      aie.use_lock(%memB_cons_cons_lock_0, Release, 1)
      aie.next_bd ^bb4
    ^bb6:  // pred: ^bb3
    ...
    ^bb7:  // 2 preds: ^bb6, ^bb8
      ...
      aie.dma_bd(%memC_buff_0 : memref<16x256xi32>, 0, 4096) {bd_id = 4 : i32, next_bd_id = 5 : i32}
      aie.use_lock(%memC_prod_lock_0, Release, 1)
      aie.next_bd ^bb8
    ^bb8:  // pred: ^bb7
      aie.use_lock(%memC_cons_lock_0, AcquireGreaterEqual, 1)
      aie.dma_bd(%memC_buff_1 : memref<16x256xi32>, 0, 4096) {bd_id = 5 : i32, next_bd_id = 4 : i32}
      aie.use_lock(%memC_prod_lock_0, Release, 1)
      aie.next_bd ^bb7
    ^bb9:  // pred: ^bb6
      aie.end
