; ModuleID = '/work/vnni-int8-matmul/npu/aie/.build/32x4096x16384/final.prj/main_core_0_2.peano-compat.ll'
source_filename = "LLVMDialectModule"
target datalayout = "e-m:e-p:20:32-i1:8:32-i8:8:32-i16:16:32-i32:32:32-f32:32:32-i64:32-f64:32-a:0:32-n32"
target triple = "aie2p"

@_anonymous0 = external local_unnamed_addr global [3 x i32]
@memA_cons_buff_1 = external global [16 x [32 x i8]]
@memA_cons_buff_0 = external global [16 x [32 x i8]]
@memB_cons_buff_1 = external global [32 x [256 x i8]]
@memB_cons_buff_0 = external global [32 x [256 x i8]]
@memC_buff_1 = external global [16 x [256 x i32]]
@memC_buff_0 = external global [16 x [256 x i32]]
...
declare void @"58a6969e_matmul_i8_i32"(ptr, ptr, ptr) local_unnamed_addr
...
2:                                                ; preds = %.preheader, %62
  ...
  %spec.select = select i1 %cond, ptr @memC_buff_1, ptr @memC_buff_0
...
5:                                                ; preds = %5, %2
  ...
  %spec.select4 = select i1 %cond1, ptr @memA_cons_buff_1, ptr @memA_cons_buff_0
  tail call void @llvm.aie2p.acquire(i32 51, i32 -1)
  %8 = load i32, ptr getelementptr inbounds nuw (i8, ptr @_anonymous0, i20 8), align 4
  %cond2 = icmp eq i32 %8, 1
  %9 = select i1 %cond2, ptr @memB_cons_buff_1, ptr @memB_cons_buff_0
  tail call void @"58a6969e_matmul_i8_i32"(ptr nonnull %spec.select4, ptr nonnull %9, ptr nonnull %spec.select)
  ...
  %spec.select4.1 = select i1 %cond1.1, ptr @memA_cons_buff_1, ptr @memA_cons_buff_0
  tail call void @llvm.aie2p.acquire(i32 51, i32 -1)
  %21 = load i32, ptr getelementptr inbounds nuw (i8, ptr @_anonymous0, i20 8), align 4
  %cond2.1 = icmp eq i32 %21, 1
  %22 = select i1 %cond2.1, ptr @memB_cons_buff_1, ptr @memB_cons_buff_0
  tail call void @"58a6969e_matmul_i8_i32"(ptr nonnull %spec.select4.1, ptr nonnull %22, ptr nonnull %spec.select)
  tail call void @llvm.aie2p.release(i32 48, i32 1)
  ...
  %spec.select4.2 = select i1 %cond1.2, ptr @memA_cons_buff_1, ptr @memA_cons_buff_0
  tail call void @llvm.aie2p.acquire(i32 51, i32 -1)
  %34 = load i32, ptr getelementptr inbounds nuw (i8, ptr @_anonymous0, i20 8), align 4
  %cond2.2 = icmp eq i32 %34, 1
  %35 = select i1 %cond2.2, ptr @memB_cons_buff_1, ptr @memB_cons_buff_0
  tail call void @"58a6969e_matmul_i8_i32"(ptr nonnull %spec.select4.2, ptr nonnull %35, ptr nonnull %spec.select)
  tail call void @llvm.aie2p.release(i32 48, i32 1)
  ...
  %spec.select4.3 = select i1 %cond1.3, ptr @memA_cons_buff_1, ptr @memA_cons_buff_0
  tail call void @llvm.aie2p.acquire(i32 51, i32 -1)
  %48 = load i32, ptr getelementptr inbounds nuw (i8, ptr @_anonymous0, i20 8), align 4
  %cond2.3 = icmp eq i32 %48, 1
  %49 = select i1 %cond2.3, ptr @memB_cons_buff_1, ptr @memB_cons_buff_0
  tail call void @"58a6969e_matmul_i8_i32"(ptr nonnull %spec.select4.3, ptr nonnull %49, ptr nonnull %spec.select)
  tail call void @llvm.aie2p.release(i32 48, i32 1)
