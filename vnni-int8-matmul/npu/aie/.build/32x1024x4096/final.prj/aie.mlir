module {
  aie.device(npu2_1col) {
    ...
    %0 = aie.core(%logical_core) {
      ...
      scf.for %arg0 = %c0 to %c9223372036854775807 step %c1 {
        ...
        scf.for %arg1 = %c0_4 to %c128 step %c1_5 {
          ...
          scf.for %arg2 = %c0_6 to %c16 step %c1_7 {
    ...
    aie.runtime_sequence(%arg0: memref<32768xi8>, %arg1: memref<4194304xi8>, %arg2: memref<131072xi32>) {
      %1 = aiex.dma_configure_task_for @inA {
        aie.dma_bd(%arg0 : memref<32768xi8>, 0, 16384, [<size = 64, stride = 0>, <size = 16, stride = 64>, <size = 16, stride = 1024>, <size = 64, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      } {repeat_count = 63 : i32}
      aiex.dma_start_task(%1)
      %2 = aiex.dma_configure_task_for @inB {
        aie.dma_bd(%arg1 : memref<4194304xi8>, 0, 65536, [<size = 64, stride = 65536>, <size = 16, stride = 64>, <size = 64, stride = 1024>, <size = 64, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      } {repeat_count = 63 : i32}
      aiex.dma_start_task(%2)
      %3 = aiex.dma_configure_task_for @inA {
        aie.dma_bd(%arg0 : memref<32768xi8>, 16384, 16384, [<size = 64, stride = 0>, <size = 16, stride = 64>, <size = 16, stride = 1024>, <size = 64, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      } {repeat_count = 63 : i32}
