  ...
  aie.device(npu2) {
    ...
    %0 = aie.core(%logical_core) {
      ...
      scf.for %arg0 = %c0 to %c9223372036854775807 step %c1 {
        ...
        scf.for %arg1 = %c0_69 to %c16 step %c1_70 {
          ...
          scf.for %arg2 = %c0_71 to %c16_72 step %c1_73 {
            ...
            %collapse_shape_74 = memref.collapse_shape %35 [[0, 1]] : memref<32x64xi8> into memref<2048xi8>
            %collapse_shape_75 = memref.collapse_shape %37 [[0, 1]] : memref<64x64xi8> into memref<4096xi8>
            %collapse_shape_76 = memref.collapse_shape %33 [[0, 1]] : memref<32x64xi32> into memref<2048xi32>
            func.call @"42bea9df_matmul_i8_i32"(%collapse_shape_74, %collapse_shape_75, %collapse_shape_76) : (memref<2048xi8>, memref<4096xi8>, memref<2048xi32>) -> ()
    ...
    aie.runtime_sequence(%arg0: memref<262144xi8>, %arg1: memref<4194304xi8>, %arg2: memref<1048576xi32>) {
      ...
      %33 = aiex.dma_configure_task_for @A_L3L2_0 {
        aie.dma_bd(%arg0 : memref<262144xi8>, 0, 32768, [<size = 8, stride = 0>, <size = 16, stride = 64>, <size = 32, stride = 1024>, <size = 64, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%33)
      %34 = aiex.dma_configure_task_for @B_L3L2_0 {
        aie.dma_bd(%arg1 : memref<4194304xi8>, 0, 65536, [<size = 8, stride = 524288>, <size = 16, stride = 64>, <size = 64, stride = 1024>, <size = 64, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%34)
      %35 = aiex.dma_configure_task_for @A_L3L2_0 {
        aie.dma_bd(%arg0 : memref<262144xi8>, 131072, 32768, [<size = 8, stride = 0>, <size = 16, stride = 64>, <size = 32, stride = 1024>, <size = 64, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      } {repeat_count = 7 : i32}
      ...
      %38 = aiex.dma_configure_task_for @A_L3L2_1 {
        aie.dma_bd(%arg0 : memref<262144xi8>, 32768, 32768, [<size = 8, stride = 0>, <size = 16, stride = 64>, <size = 32, stride = 1024>, <size = 64, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%38)
      %39 = aiex.dma_configure_task_for @B_L3L2_1 {
        aie.dma_bd(%arg1 : memref<4194304xi8>, 65536, 65536, [<size = 8, stride = 524288>, <size = 16, stride = 64>, <size = 64, stride = 1024>, <size = 64, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%39)
      %40 = aiex.dma_configure_task_for @A_L3L2_1 {
        aie.dma_bd(%arg0 : memref<262144xi8>, 163840, 32768, [<size = 8, stride = 0>, <size = 16, stride = 64>, <size = 32, stride = 1024>, <size = 64, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      } {repeat_count = 7 : i32}
      ...
      %43 = aiex.dma_configure_task_for @A_L3L2_2 {
        aie.dma_bd(%arg0 : memref<262144xi8>, 65536, 32768, [<size = 8, stride = 0>, <size = 16, stride = 64>, <size = 32, stride = 1024>, <size = 64, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%43)
      %44 = aiex.dma_configure_task_for @B_L3L2_2 {
        aie.dma_bd(%arg1 : memref<4194304xi8>, 131072, 65536, [<size = 8, stride = 524288>, <size = 16, stride = 64>, <size = 64, stride = 1024>, <size = 64, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%44)
      %45 = aiex.dma_configure_task_for @A_L3L2_2 {
        aie.dma_bd(%arg0 : memref<262144xi8>, 196608, 32768, [<size = 8, stride = 0>, <size = 16, stride = 64>, <size = 32, stride = 1024>, <size = 64, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      } {repeat_count = 7 : i32}
      ...
      %48 = aiex.dma_configure_task_for @A_L3L2_3 {
        aie.dma_bd(%arg0 : memref<262144xi8>, 98304, 32768, [<size = 8, stride = 0>, <size = 16, stride = 64>, <size = 32, stride = 1024>, <size = 64, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%48)
      %49 = aiex.dma_configure_task_for @B_L3L2_3 {
        aie.dma_bd(%arg1 : memref<4194304xi8>, 196608, 65536, [<size = 8, stride = 524288>, <size = 16, stride = 64>, <size = 64, stride = 1024>, <size = 64, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%49)
      %50 = aiex.dma_configure_task_for @A_L3L2_3 {
        aie.dma_bd(%arg0 : memref<262144xi8>, 229376, 32768, [<size = 8, stride = 0>, <size = 16, stride = 64>, <size = 32, stride = 1024>, <size = 64, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      } {repeat_count = 7 : i32}
      ...
      %53 = aiex.dma_configure_task_for @B_L3L2_4 {
        aie.dma_bd(%arg1 : memref<4194304xi8>, 262144, 65536, [<size = 8, stride = 524288>, <size = 16, stride = 64>, <size = 64, stride = 1024>, <size = 64, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      } {repeat_count = 7 : i32}
      ...
      %56 = aiex.dma_configure_task_for @B_L3L2_5 {
        aie.dma_bd(%arg1 : memref<4194304xi8>, 327680, 65536, [<size = 8, stride = 524288>, <size = 16, stride = 64>, <size = 64, stride = 1024>, <size = 64, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      } {repeat_count = 7 : i32}
      ...
      %59 = aiex.dma_configure_task_for @B_L3L2_6 {
        aie.dma_bd(%arg1 : memref<4194304xi8>, 393216, 65536, [<size = 8, stride = 524288>, <size = 16, stride = 64>, <size = 64, stride = 1024>, <size = 64, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      } {repeat_count = 7 : i32}
      ...
      %62 = aiex.dma_configure_task_for @B_L3L2_7 {
        aie.dma_bd(%arg1 : memref<4194304xi8>, 458752, 65536, [<size = 8, stride = 524288>, <size = 16, stride = 64>, <size = 64, stride = 1024>, <size = 64, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      } {repeat_count = 7 : i32}
