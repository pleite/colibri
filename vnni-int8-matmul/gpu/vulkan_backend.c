...
static int load_dispatch(VnnVulkanDispatch *dispatch) {
    ...
    dispatch->vkGetPhysicalDeviceMemoryProperties = (PFN_vkGetPhysicalDeviceMemoryProperties)get_proc_addr(NULL, "vkGetPhysicalDeviceMemoryProperties");
    dispatch->vkCreateDevice = (PFN_vkCreateDevice)get_proc_addr(NULL, "vkCreateDevice");
    dispatch->vkDestroyDevice = (PFN_vkDestroyDevice)get_proc_addr(NULL, "vkDestroyDevice");
    dispatch->vkGetDeviceQueue = (PFN_vkGetDeviceQueue)get_proc_addr(NULL, "vkGetDeviceQueue");
    dispatch->vkCreateCommandPool = (PFN_vkCreateCommandPool)get_proc_addr(NULL, "vkCreateCommandPool");
    dispatch->vkDestroyCommandPool = (PFN_vkDestroyCommandPool)get_proc_addr(NULL, "vkDestroyCommandPool");
    dispatch->vkAllocateCommandBuffers = (PFN_vkAllocateCommandBuffers)get_proc_addr(NULL, "vkAllocateCommandBuffers");
    dispatch->vkFreeCommandBuffers = (PFN_vkFreeCommandBuffers)get_proc_addr(NULL, "vkFreeCommandBuffers");
    dispatch->vkBeginCommandBuffer = (PFN_vkBeginCommandBuffer)get_proc_addr(NULL, "vkBeginCommandBuffer");
    dispatch->vkEndCommandBuffer = (PFN_vkEndCommandBuffer)get_proc_addr(NULL, "vkEndCommandBuffer");
    dispatch->vkCreateDescriptorSetLayout = (PFN_vkCreateDescriptorSetLayout)get_proc_addr(NULL, "vkCreateDescriptorSetLayout");
    dispatch->vkDestroyDescriptorSetLayout = (PFN_vkDestroyDescriptorSetLayout)get_proc_addr(NULL, "vkDestroyDescriptorSetLayout");
    dispatch->vkCreateShaderModule = (PFN_vkCreateShaderModule)get_proc_addr(NULL, "vkCreateShaderModule");
    dispatch->vkDestroyShaderModule = (PFN_vkDestroyShaderModule)get_proc_addr(NULL, "vkDestroyShaderModule");
    dispatch->vkCreatePipelineLayout = (PFN_vkCreatePipelineLayout)get_proc_addr(NULL, "vkCreatePipelineLayout");
    dispatch->vkDestroyPipelineLayout = (PFN_vkDestroyPipelineLayout)get_proc_addr(NULL, "vkDestroyPipelineLayout");
    dispatch->vkCreateComputePipelines = (PFN_vkCreateComputePipelines)get_proc_addr(NULL, "vkCreateComputePipelines");
    dispatch->vkDestroyPipeline = (PFN_vkDestroyPipeline)get_proc_addr(NULL, "vkDestroyPipeline");
    dispatch->vkCreateDescriptorPool = (PFN_vkCreateDescriptorPool)get_proc_addr(NULL, "vkCreateDescriptorPool");
    dispatch->vkDestroyDescriptorPool = (PFN_vkDestroyDescriptorPool)get_proc_addr(NULL, "vkDestroyDescriptorPool");
    dispatch->vkAllocateDescriptorSets = (PFN_vkAllocateDescriptorSets)get_proc_addr(NULL, "vkAllocateDescriptorSets");
    dispatch->vkUpdateDescriptorSets = (PFN_vkUpdateDescriptorSets)get_proc_addr(NULL, "vkUpdateDescriptorSets");
    dispatch->vkCreateBuffer = (PFN_vkCreateBuffer)get_proc_addr(NULL, "vkCreateBuffer");
    dispatch->vkDestroyBuffer = (PFN_vkDestroyBuffer)get_proc_addr(NULL, "vkDestroyBuffer");
    dispatch->vkGetBufferMemoryRequirements = (PFN_vkGetBufferMemoryRequirements)get_proc_addr(NULL, "vkGetBufferMemoryRequirements");
    dispatch->vkAllocateMemory = (PFN_vkAllocateMemory)get_proc_addr(NULL, "vkAllocateMemory");
    dispatch->vkFreeMemory = (PFN_vkFreeMemory)get_proc_addr(NULL, "vkFreeMemory");
    dispatch->vkBindBufferMemory = (PFN_vkBindBufferMemory)get_proc_addr(NULL, "vkBindBufferMemory");
    dispatch->vkMapMemory = (PFN_vkMapMemory)get_proc_addr(NULL, "vkMapMemory");
    dispatch->vkUnmapMemory = (PFN_vkUnmapMemory)get_proc_addr(NULL, "vkUnmapMemory");
    dispatch->vkCmdBindPipeline = (PFN_vkCmdBindPipeline)get_proc_addr(NULL, "vkCmdBindPipeline");
    dispatch->vkCmdBindDescriptorSets = (PFN_vkCmdBindDescriptorSets)get_proc_addr(NULL, "vkCmdBindDescriptorSets");
    dispatch->vkCmdPushConstants = (PFN_vkCmdPushConstants)get_proc_addr(NULL, "vkCmdPushConstants");
    dispatch->vkCmdDispatch = (PFN_vkCmdDispatch)get_proc_addr(NULL, "vkCmdDispatch");
    dispatch->vkQueueSubmit = (PFN_vkQueueSubmit)get_proc_addr(NULL, "vkQueueSubmit");
    dispatch->vkWaitForFences = (PFN_vkWaitForFences)get_proc_addr(NULL, "vkWaitForFences");
    dispatch->vkCreateFence = (PFN_vkCreateFence)get_proc_addr(NULL, "vkCreateFence");
    dispatch->vkDestroyFence = (PFN_vkDestroyFence)get_proc_addr(NULL, "vkDestroyFence");
